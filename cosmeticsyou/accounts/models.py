...
class FullConsultant(ConsultantBase):
    ...
    citizenship = models.BooleanField(_('Не гражданин РФ'), default=False, blank=True,)
    ...
    region = models.CharField(_('Почтовый Индекс'), max_length=50, blank=True, null=True,)
